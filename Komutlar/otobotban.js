...
exports.run = async (client, message, args) => {
  ...
  if (args[0] == 'aç' || args[0] === "ac") {
    message.channel.sendEmbed(new Discord.RichEmbed().setDescription(`**Oto Bot Ban** Özelliği Başarıyla **Aktifleştirildi!** <a:tag:689808649652142183> Artık sunucuya giren botları otomatik olarak **sunucudan yasaklayacağım.**`).setColor("GREEN"));
